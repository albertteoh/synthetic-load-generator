...
//                long childStartTimeMicros = startTimeMicros + TimeUnit.MILLISECONDS.toMicros(random.nextInt(route.maxLatencyMillis));
                long childStartTimeMicros = startTimeMicros + TimeUnit.MILLISECONDS.toMicros(route.exactLatencyMillis);
        ...
        long ownDuration = TimeUnit.MILLISECONDS.toMicros(route.exactLatencyMillis);
